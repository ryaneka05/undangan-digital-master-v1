                ...
                >
                    ...
                    <div className="space-y-4">
                        ...
                        <motion.h2
                            ...
                            className="text-3xl sm:text-5xl font-serif bg-clip-text text-transparent from-rose-600 to-pink-600"
                        >
                    ...
                    >
                        <div className="absolute inset-0 from-rose-50/50 to-white/50 backdrop-blur-md rounded-2xl" />

                        <div className="relative px-4 sm:px-8 py-8 sm:py-10 rounded-2xl border border-rose-100/50">
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-px">
                                <div className="w-20 sm:w-32 from-transparent via-rose-200 to-transparent" />
                            </div>
